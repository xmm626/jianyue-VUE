<template>
	<view class="container">
		...
		<view class="grace-text" style="margin-top: 40px;"><rich-text :nodes="article.content" bindtap="tap"></rich-text></view>
		<button v-if="userId != article.uId && !likeed" class="green-btn follow-btn1" @tap="like">点赞</button>
		<button v-if="userId != article.uId && likeed" class="green-btn follow-btn1 cancel" @tap="cancelLike">取消</button>
		...
		<view class="comment-item" v-for="(comment, index) in comments" :key="index">
			...
			<view class="right">
				...
				<p>{{ handleContent(comment.content) }}</p>
				<view>
